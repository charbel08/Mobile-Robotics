...
class AStarPlanner(object):
    ...
    def euclidean_dist(self, start_state, dest_state):
        return sqrt((start_state.x - dest_state.x)**2 + (start_state.y - dest_state.y)**2)
        ...
        while Q:
            ...
            for ns in self.get_neighboring_states(s):
                ...
                if (ns not in Q) or (alternative_dist_to_come_to_ns < dist_to_come[ns.x, ns.y]):
                    Q[ns] = alternative_dist_to_come_to_ns + self.euclidean_dist(ns, dest_state)
